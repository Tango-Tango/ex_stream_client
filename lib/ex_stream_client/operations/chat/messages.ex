defmodule ExStreamClient.Chat.Messages do
        ...
        decode: fn {request, response} ->
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response({:ok, response.body}, {:component, "PollVoteResponse"})
            ...
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response(
                  {:ok, response.body},
                  {:component, "DeleteReactionResponse"}
                )
          ...
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response(
                  {:ok, response.body},
                  {:component, "SendReactionResponse"}
                )
      ...
      |> Req.Request.append_response_steps(
        decode: fn {request, response} ->
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response({:ok, response.body}, {:component, "MessageResponse"})
          ...
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response(
                  {:ok, response.body},
                  {:component, "QueryMessageHistoryResponse"}
                )
  ...
  def query_reactions(id, payload) do
    request_opts =
      [url: "/api/v2/chat/messages/#{id}/reactions", method: :post, params: %{}] ++
        [json: payload]
          ...
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response(
                  {:ok, response.body},
                  {:component, "QueryReactionsResponse"}
                )
          ...
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response(
                  {:ok, response.body},
                  {:component, "GetReactionsResponse"}
                )
      ...
      |> Req.Request.append_response_steps(
        decode: fn {request, response} ->
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response({:ok, response.body}, {:component, "GetRepliesResponse"})
          ...
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response(
                  {:ok, response.body},
                  {:component, "UpdateMessageResponse"}
                )
  ...
  def translate_message(id, payload) do
    request_opts =
      [url: "/api/v2/chat/messages/#{id}/translate", method: :post, params: %{}] ++
        [json: payload]
          ...
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response(
                  {:ok, response.body},
                  {:component, "UpdateMessagePartialResponse"}
                )
      ...
      |> Req.Request.append_response_steps(
        decode: fn {request, response} ->
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response({:ok, response.body}, {:component, "GetMessageResponse"})
          ...
          case response.status do
            code when code in 200..299 ->
              parsed =
                Codegen.convert_response(
                  {:ok, response.body},
                  {:component, "DeleteMessageResponse"}
                )
